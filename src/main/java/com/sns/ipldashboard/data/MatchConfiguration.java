package com.sns.ipldashboard.data;
...
public class MatchConfiguration {
    ...
    public static final String INSERT_MATCH_SQL = "INSERT INTO match (id, city, date, player_of_match, venue, team1, team2, toss_winner, toss_decision, match_winner, result, result_margin, umpire1, umpire2) " +
